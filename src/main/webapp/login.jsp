...
<body>
		...
		<div class="login">
			<form id="loginForm" action="${pageContext.request.contextPath}/mymanager/login" method="post" >
				<table>
					<tbody>
						<tr>
					...
					<tr>
						...
						<th>&nbsp;</th>
						<td>
							<input type="button" class="homeButton" value="" onclick="location.href='/'"><input type="submit" class="loginButton" value="登录"><a style="color: red;" >${sessionScope.loginstatus} </a>
						</td>
					</tr>
				</tbody></table>
